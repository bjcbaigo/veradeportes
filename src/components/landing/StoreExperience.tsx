  ...
  return (
    <section className="relative overflow-hidden bg-ink text-ink-foreground">
      <img
        ...
        height={768}
        loading="lazy"
        className="absolute inset-0 h-full w-full object-cover object-[58%_center] opacity-65 sm:object-center"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-ink via-ink/85 to-ink/20" />
      <div className="relative mx-auto flex min-h-[370px] max-w-7xl items-end px-5 py-10 sm:min-h-[430px] sm:items-center sm:px-8 xl:px-6">
