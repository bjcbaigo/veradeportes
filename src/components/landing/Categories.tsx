          ...
          <div className="flex gap-3 min-w-max md:min-w-0 md:grid md:grid-cols-6">
            {CATS.map((c) => (
              <a
                key={c.label}
                href="#productos"
                className="flex flex-col items-center justify-between rounded-2xl bg-card border border-border shadow-sm p-3 w-[110px] md:w-auto hover:border-primary/50 transition"
              >
