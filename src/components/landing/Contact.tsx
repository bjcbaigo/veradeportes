...
const CARDS = [
  ...
  },
  {
    ...
    href: SITE.instagram,
    accent:
      "bg-gradient-to-tr from-[oklch(0.55_0.22_15)] via-[oklch(0.65_0.22_330)] to-[oklch(0.7_0.18_60)] text-white",
  },
  {
    icon: MapPin,
    title: "Como llegar",
          ...
          {CARDS.map(({ icon, image, title, text, href, accent }) => {
            ...
            return (
              <a
                ...
                href={href}
                onClick={(e) => {
                  if (title === "WhatsApp") requireCustomerAccess(e, "whatsapp", href);
                }}
                target="_blank"
                rel="noopener"
              ...
              >
                <span
                  className={`flex-none inline-flex h-11 w-11 items-center justify-center rounded-full overflow-hidden ${accent}`}
                >
                  {image ? (
